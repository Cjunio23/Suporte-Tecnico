...
public class SuporteTecnico {
   ...
   public String BuscarSolucao(HashSet b){
     for (Object a : b) {  
       for (String i : bancoSolucao.keySet()) {
           
           if(a.equals(i)){ 
               return bancoSolucao.get(i);
           }
        }
     }
     return null;
   ...
   public String BuscaSolucaoPadrao(HashSet b){
       Random rand = new Random(); 
       return respostaPadrao.get(rand.nextInt(9));   
